...
/* Bit 19 : WUCOMP_COMP region configuration. */
#define MPU_PERR0_WUCOMP_COMP_Pos (19UL) /*!< Position of WUCOMP_COMP field. */
#define MPU_PERR0_WUCOMP_COMP_Msk (0x1UL << MPU_PERR0_WUCOMP_COMP_Pos) /*!< Bit mask of WUCOMP_COMP field. */
#define MPU_PERR0_WUCOMP_COMP_InRegion1 (0UL) /*!< Peripheral configured in region 1. */
#define MPU_PERR0_WUCOMP_COMP_InRegion0 (1UL) /*!< Peripheral configured in region 0. */
...
/* Bit 17 : Reset from wake-up from OFF mode detected by the use of ANADETECT signal from WUCOMP. */
#define POWER_RESETREAS_WUCOMP_Pos (17UL) /*!< Position of WUCOMP field. */
#define POWER_RESETREAS_WUCOMP_Msk (0x1UL << POWER_RESETREAS_WUCOMP_Pos) /*!< Bit mask of WUCOMP field. */
...
/* Register: RTC_EVTEN */
/* Description: Configures event enable state for each RTC event. */
...
/* Description: Enable events. The reading of this register gives the value of EVTEN. */

/* Bit 19 : Enable COMPARE[3] event. */
...
/* Description: Disable events. The reading of this register gives the value of EVTEN. */

/* Bit 19 : Disable COMPARE[3] event. */
...
/* Bit 18 : Disable COMPARE[2] event. */
...
/* Bit 17 : Disable COMPARE[1] event. */
...
/* Bit 16 : Disable COMPARE[0] event. */
...
/* Register: WUCOMP_SHORTS */
/* Description: Shortcut for the WUCOMP. */

/* Bit 4 : Short-cut between CROSS event and STOP task. */
#define WUCOMP_SHORTS_CROSS_STOP_Pos (4UL) /*!< Position of CROSS_STOP field. */
#define WUCOMP_SHORTS_CROSS_STOP_Msk (0x1UL << WUCOMP_SHORTS_CROSS_STOP_Pos) /*!< Bit mask of CROSS_STOP field. */
#define WUCOMP_SHORTS_CROSS_STOP_Disabled (0UL) /*!< Shortcut disabled. */
#define WUCOMP_SHORTS_CROSS_STOP_Enabled (1UL) /*!< Shortcut enabled. */

/* Bit 3 : Short-cut between UP event and STOP task. */
#define WUCOMP_SHORTS_UP_STOP_Pos (3UL) /*!< Position of UP_STOP field. */
#define WUCOMP_SHORTS_UP_STOP_Msk (0x1UL << WUCOMP_SHORTS_UP_STOP_Pos) /*!< Bit mask of UP_STOP field. */
#define WUCOMP_SHORTS_UP_STOP_Disabled (0UL) /*!< Shortcut disabled. */
#define WUCOMP_SHORTS_UP_STOP_Enabled (1UL) /*!< Shortcut enabled. */

/* Bit 2 : Short-cut between DOWN event and STOP task. */
#define WUCOMP_SHORTS_DOWN_STOP_Pos (2UL) /*!< Position of DOWN_STOP field. */
#define WUCOMP_SHORTS_DOWN_STOP_Msk (0x1UL << WUCOMP_SHORTS_DOWN_STOP_Pos) /*!< Bit mask of DOWN_STOP field. */
#define WUCOMP_SHORTS_DOWN_STOP_Disabled (0UL) /*!< Shortcut disabled. */
#define WUCOMP_SHORTS_DOWN_STOP_Enabled (1UL) /*!< Shortcut enabled. */

/* Bit 1 : Short-cut between RADY event and STOP task. */
#define WUCOMP_SHORTS_READY_STOP_Pos (1UL) /*!< Position of READY_STOP field. */
#define WUCOMP_SHORTS_READY_STOP_Msk (0x1UL << WUCOMP_SHORTS_READY_STOP_Pos) /*!< Bit mask of READY_STOP field. */
#define WUCOMP_SHORTS_READY_STOP_Disabled (0UL) /*!< Shortcut disabled. */
#define WUCOMP_SHORTS_READY_STOP_Enabled (1UL) /*!< Shortcut enabled. */

/* Bit 0 : Short-cut between READY event and SAMPLE task. */
#define WUCOMP_SHORTS_READY_SAMPLE_Pos (0UL) /*!< Position of READY_SAMPLE field. */
#define WUCOMP_SHORTS_READY_SAMPLE_Msk (0x1UL << WUCOMP_SHORTS_READY_SAMPLE_Pos) /*!< Bit mask of READY_SAMPLE field. */
#define WUCOMP_SHORTS_READY_SAMPLE_Disabled (0UL) /*!< Shortcut disabled. */
#define WUCOMP_SHORTS_READY_SAMPLE_Enabled (1UL) /*!< Shortcut enabled. */

/* Register: WUCOMP_INTENSET */
/* Description: Interrupt enable set register. */

/* Bit 3 : Enable interrupt on CROSS event. */
#define WUCOMP_INTENSET_CROSS_Pos (3UL) /*!< Position of CROSS field. */
#define WUCOMP_INTENSET_CROSS_Msk (0x1UL << WUCOMP_INTENSET_CROSS_Pos) /*!< Bit mask of CROSS field. */
#define WUCOMP_INTENSET_CROSS_Disabled (0UL) /*!< Interrupt disabled. */
#define WUCOMP_INTENSET_CROSS_Enabled (1UL) /*!< Interrupt enabled. */
#define WUCOMP_INTENSET_CROSS_Set (1UL) /*!< Enable interrupt on write. */

/* Bit 2 : Enable interrupt on UP event. */
#define WUCOMP_INTENSET_UP_Pos (2UL) /*!< Position of UP field. */
#define WUCOMP_INTENSET_UP_Msk (0x1UL << WUCOMP_INTENSET_UP_Pos) /*!< Bit mask of UP field. */
#define WUCOMP_INTENSET_UP_Disabled (0UL) /*!< Interrupt disabled. */
#define WUCOMP_INTENSET_UP_Enabled (1UL) /*!< Interrupt enabled. */
#define WUCOMP_INTENSET_UP_Set (1UL) /*!< Enable interrupt on write. */

/* Bit 1 : Enable interrupt on DOWN event. */
#define WUCOMP_INTENSET_DOWN_Pos (1UL) /*!< Position of DOWN field. */
#define WUCOMP_INTENSET_DOWN_Msk (0x1UL << WUCOMP_INTENSET_DOWN_Pos) /*!< Bit mask of DOWN field. */
#define WUCOMP_INTENSET_DOWN_Disabled (0UL) /*!< Interrupt disabled. */
#define WUCOMP_INTENSET_DOWN_Enabled (1UL) /*!< Interrupt enabled. */
#define WUCOMP_INTENSET_DOWN_Set (1UL) /*!< Enable interrupt on write. */

/* Bit 0 : Enable interrupt on READY event. */
#define WUCOMP_INTENSET_READY_Pos (0UL) /*!< Position of READY field. */
#define WUCOMP_INTENSET_READY_Msk (0x1UL << WUCOMP_INTENSET_READY_Pos) /*!< Bit mask of READY field. */
#define WUCOMP_INTENSET_READY_Disabled (0UL) /*!< Interrupt disabled. */
#define WUCOMP_INTENSET_READY_Enabled (1UL) /*!< Interrupt enabled. */
#define WUCOMP_INTENSET_READY_Set (1UL) /*!< Enable interrupt on write. */

/* Register: WUCOMP_INTENCLR */
/* Description: Interrupt enable clear register. */

/* Bit 3 : Disable interrupt on CROSS event. */
#define WUCOMP_INTENCLR_CROSS_Pos (3UL) /*!< Position of CROSS field. */
#define WUCOMP_INTENCLR_CROSS_Msk (0x1UL << WUCOMP_INTENCLR_CROSS_Pos) /*!< Bit mask of CROSS field. */
#define WUCOMP_INTENCLR_CROSS_Disabled (0UL) /*!< Interrupt disabled. */
#define WUCOMP_INTENCLR_CROSS_Enabled (1UL) /*!< Interrupt enabled. */
#define WUCOMP_INTENCLR_CROSS_Clear (1UL) /*!< Disable interrupt on write. */

/* Bit 2 : Disable interrupt on UP event. */
#define WUCOMP_INTENCLR_UP_Pos (2UL) /*!< Position of UP field. */
#define WUCOMP_INTENCLR_UP_Msk (0x1UL << WUCOMP_INTENCLR_UP_Pos) /*!< Bit mask of UP field. */
#define WUCOMP_INTENCLR_UP_Disabled (0UL) /*!< Interrupt disabled. */
#define WUCOMP_INTENCLR_UP_Enabled (1UL) /*!< Interrupt enabled. */
#define WUCOMP_INTENCLR_UP_Clear (1UL) /*!< Disable interrupt on write. */

/* Bit 1 : Disable interrupt on DOWN event. */
#define WUCOMP_INTENCLR_DOWN_Pos (1UL) /*!< Position of DOWN field. */
#define WUCOMP_INTENCLR_DOWN_Msk (0x1UL << WUCOMP_INTENCLR_DOWN_Pos) /*!< Bit mask of DOWN field. */
#define WUCOMP_INTENCLR_DOWN_Disabled (0UL) /*!< Interrupt disabled. */
#define WUCOMP_INTENCLR_DOWN_Enabled (1UL) /*!< Interrupt enabled. */
#define WUCOMP_INTENCLR_DOWN_Clear (1UL) /*!< Disable interrupt on write. */

/* Bit 0 : Disable interrupt on READY event. */
#define WUCOMP_INTENCLR_READY_Pos (0UL) /*!< Position of READY field. */
#define WUCOMP_INTENCLR_READY_Msk (0x1UL << WUCOMP_INTENCLR_READY_Pos) /*!< Bit mask of READY field. */
#define WUCOMP_INTENCLR_READY_Disabled (0UL) /*!< Interrupt disabled. */
#define WUCOMP_INTENCLR_READY_Enabled (1UL) /*!< Interrupt enabled. */
#define WUCOMP_INTENCLR_READY_Clear (1UL) /*!< Disable interrupt on write. */

/* Register: WUCOMP_RESULT */
/* Description: Result of last compare. */

/* Bit 0 : Result of last compare. Decision point SAMPLE task. */
#define WUCOMP_RESULT_RESULT_Pos (0UL) /*!< Position of RESULT field. */
#define WUCOMP_RESULT_RESULT_Msk (0x1UL << WUCOMP_RESULT_RESULT_Pos) /*!< Bit mask of RESULT field. */
#define WUCOMP_RESULT_RESULT_Bellow (0UL) /*!< Input voltage is bellow the reference threshold. */
#define WUCOMP_RESULT_RESULT_Above (1UL) /*!< Input voltage is above the reference threshold. */

/* Register: WUCOMP_ENABLE */
/* Description: Enable the WUCOMP. */

/* Bits 1..0 : Enable or disable WUCOMP. */
#define WUCOMP_ENABLE_ENABLE_Pos (0UL) /*!< Position of ENABLE field. */
#define WUCOMP_ENABLE_ENABLE_Msk (0x3UL << WUCOMP_ENABLE_ENABLE_Pos) /*!< Bit mask of ENABLE field. */
#define WUCOMP_ENABLE_ENABLE_Disabled (0x00UL) /*!< Disabled WUCOMP. */
#define WUCOMP_ENABLE_ENABLE_Enabled (0x01UL) /*!< Enable WUCOMP. */

/* Register: WUCOMP_PSEL */
/* Description: Input pin select. */

/* Bits 2..0 : Analog input pin select. */
#define WUCOMP_PSEL_PSEL_Pos (0UL) /*!< Position of PSEL field. */
#define WUCOMP_PSEL_PSEL_Msk (0x7UL << WUCOMP_PSEL_PSEL_Pos) /*!< Bit mask of PSEL field. */
#define WUCOMP_PSEL_PSEL_AnalogInput0 (0UL) /*!< Use analog input 0 as analog input. */
#define WUCOMP_PSEL_PSEL_AnalogInput1 (1UL) /*!< Use analog input 1 as analog input. */
#define WUCOMP_PSEL_PSEL_AnalogInput2 (2UL) /*!< Use analog input 2 as analog input. */
#define WUCOMP_PSEL_PSEL_AnalogInput3 (3UL) /*!< Use analog input 3 as analog input. */
#define WUCOMP_PSEL_PSEL_AnalogInput4 (4UL) /*!< Use analog input 4 as analog input. */
#define WUCOMP_PSEL_PSEL_AnalogInput5 (5UL) /*!< Use analog input 5 as analog input. */
#define WUCOMP_PSEL_PSEL_AnalogInput6 (6UL) /*!< Use analog input 6 as analog input. */
#define WUCOMP_PSEL_PSEL_AnalogInput7 (7UL) /*!< Use analog input 7 as analog input. */

/* Register: WUCOMP_REFSEL */
/* Description: Reference select. */

/* Bits 2..0 : Reference select. */
#define WUCOMP_REFSEL_REFSEL_Pos (0UL) /*!< Position of REFSEL field. */
#define WUCOMP_REFSEL_REFSEL_Msk (0x7UL << WUCOMP_REFSEL_REFSEL_Pos) /*!< Bit mask of REFSEL field. */
#define WUCOMP_REFSEL_REFSEL_SupplyOneEighthPrescaling (0UL) /*!< Use analog supply with a 1/8 prescaler as reference. */
#define WUCOMP_REFSEL_REFSEL_SupplyTwoEighthsPrescaling (1UL) /*!< Use analog supply with a 2/8 prescaler as reference. */
#define WUCOMP_REFSEL_REFSEL_SupplyThreeEighthsPrescaling (2UL) /*!< Use analog supply with a 3/8 prescaler as reference. */
#define WUCOMP_REFSEL_REFSEL_SupplyFourEighthsPrescaling (3UL) /*!< Use analog supply with a 4/8 prescaler as reference. */
#define WUCOMP_REFSEL_REFSEL_SupplyFiveEighthsPrescaling (4UL) /*!< Use analog supply with a 5/8 prescaler as reference. */
#define WUCOMP_REFSEL_REFSEL_SupplySixEighthsPrescaling (5UL) /*!< Use analog supply with a 6/8 prescaler as reference. */
#define WUCOMP_REFSEL_REFSEL_SupplySevenEighthsPrescaling (6UL) /*!< Use analog supply with a 7/8 prescaler as reference. */
#define WUCOMP_REFSEL_REFSEL_ARef (7UL) /*!< Use external analog reference as reference. */

/* Register: WUCOMP_EXTREFSEL */
/* Description: External reference select. */

/* Bit 0 : External analog reference pin selection. */
#define WUCOMP_EXTREFSEL_EXTREFSEL_Pos (0UL) /*!< Position of EXTREFSEL field. */
#define WUCOMP_EXTREFSEL_EXTREFSEL_Msk (0x1UL << WUCOMP_EXTREFSEL_EXTREFSEL_Pos) /*!< Bit mask of EXTREFSEL field. */
#define WUCOMP_EXTREFSEL_EXTREFSEL_AnalogReference0 (0UL) /*!< Use analog reference 0 as reference. */
#define WUCOMP_EXTREFSEL_EXTREFSEL_AnalogReference1 (1UL) /*!< Use analog reference 1 as reference. */

/* Register: WUCOMP_ANADETECT */
/* Description: Analog detect configuration. */

/* Bits 1..0 : Analog detect configuration. */
#define WUCOMP_ANADETECT_ANADETECT_Pos (0UL) /*!< Position of ANADETECT field. */
#define WUCOMP_ANADETECT_ANADETECT_Msk (0x3UL << WUCOMP_ANADETECT_ANADETECT_Pos) /*!< Bit mask of ANADETECT field. */
#define WUCOMP_ANADETECT_ANADETECT_Cross (0UL) /*!< Generate ANADETEC on crossing, both upwards and downwards crossing. */
#define WUCOMP_ANADETECT_ANADETECT_Up (1UL) /*!< Generate ANADETEC on upwards crossing only. */
#define WUCOMP_ANADETECT_ANADETECT_Down (2UL) /*!< Generate ANADETEC on downwards crossing only. */
