...
/** \brief Print a newline (the newline output sequence)
 * \pre only works if init() previously called
 */
...
/** \brief Print the hexadecimal ASCII representation of a word (two octets)
 * 
...
/** \brief Checks the last tx is completed
 *
