...
/**
  @brief Attempts to soft-reset the device
...
/**
  @brief Reads the interrupt status register of the device. This clears all interrupts.
...
/**
  @brief Function to read a touchpad register contents over TWI.  
...
/**
  @brief Writes a touchpad register contents over TWI.
  @param[in]  register_address Register address
...
/**
  @brief Writes touchpad register contents over TWI.
...
/**
  @brief Reads and verifies touchpad's product ID.
