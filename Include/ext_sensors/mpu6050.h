...
/**
 * Initializes MPU6050 and verifies it's on the bus.
 *
...
/**
  @brief Writes a MPU6050 register contents over TWI.
...
/**
  @brief Function to read MPU6050 register contents over TWI.
...
/**
  @brief Reads and verifies MPU6050 product ID.
