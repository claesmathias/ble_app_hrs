...
/**
 * Initializes 2-wire serial interface and tries to handle stuck slaves.
 * 
 */
void sdio_init(void);

/**
 * Reads a byte over 2-wire serial interface.
 * 
...
/**
 * Reads several bytes over 2-wire serial interface using burst mode.
 * 
 * Developer needs to implement this function in a way that suits the hardware.
...
/**
 * Writes a byte over 2-wire serial interface.
 * 
 * Developer needs to implement this function in a way that suits the hardware.
