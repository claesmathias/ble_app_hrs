...
/**
 * Initializes DS1624 temperature sensor to 1-shot mode.
 *
...
/**
 * Starts temperature conversion. Valid data will be available 400-1000 milliseconds after exiting this function.
 *
 * @return
...
/**
 * Checks if temperature conversion is done.
 *
 * @return
