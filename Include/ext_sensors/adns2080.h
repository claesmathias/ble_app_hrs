...
/**
 * Initializes the mouse sensor chip.
 *
...
/**
 * Reads mouse sensor revision ID.
 *
 * Chip is expected to be initialized before calling this function.
 *
 * @return Product ID.
...
/**
 * Configures MOTION interrupt output pin.
 *
...
/**
 * Sets number of bits used for mouse sensor motion reporting.
 *
 * Chip is expected to be initialized before calling this function.
 *
...
/**
 * Reads number of bits used for mouse sensor motion reporting.
 *
 * Chip is expected to be initialized before calling this function.
 *
...
/**
 * Reads X- and Y-axis movement (in counts) since last report.
 *
...
/**
 * Checks if motion has been detected since last call.
 *
 * Chip is expected to be initialized before calling this function.
 *
 * @return
...
/**
 * Sets mouse sensor Rest1, Rest2 and Rest3 mode motion detection time period.
 * 
...
/**
 * Sets mouse sensor mode downshift time periods.
 * 
...
/**
 * Forces mouse sensor to a certain operating mode.
 * 
 * Chip is expected to be initialized before calling this function.
...
/**
 * Reads current forced operating mode.
 * 
 * Chip is expected to be initialized before calling this function.
 *
