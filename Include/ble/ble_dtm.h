...
/**@brief  Initialize or re-initialize DTM module
 *     
...
/**@brief Called to give control to dtmlib for handling timer and radio events.
...
/**@brief Called when a complete command has been prepared by the Tester.
 *
...
/**@brief Called to read the result of a DTM command
 *
...
/**@brief Configure the timer to use.
 *
...
/**@brief Configure the transmit power.
 *
 * @note        Must be called when no DTM test is running.
 * 
