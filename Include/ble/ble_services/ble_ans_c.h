...
/**@brief Alert Notification Client BLE stack event handler.
 *
...
/**@brief Alert Notification Client - Bond Manager stack event handler.
 *
...
/**@brief Initialize the Alert Notification Client.
 *
...
/**@brief Write the CCCD to enable new alert notifications from the Alert Notification Service.
 *
...
/**@brief Write the CCCD to enable unread alert notifications from the Alert Notification Service.
 *
 * @param[in]  p_ans       Alert Notification structure. This structure will have to be supplied by
 *                         the application. It identifies the particular client instance to use.
 *
...
/**@brief Write the CCCD to disable new alert notifications from the Alert Notification Service.
 *
 * @param[in]  p_ans       Alert Notification structure. This structure will have to be supplied by
 *                         the application. It identifies the particular client instance to use.
 *
...
/**@brief Write the CCCD to disable unread alert notifications from the Alert Notification Service.
 *
 * @param[in]  p_ans       Alert Notification structure. This structure will have to be supplied by
 *                         the application. It identifies the particular client instance to use.
 *
...
/**@brief Write the Alert Notification Control Point to specify alert notification behavior in the
...
/**@brief Read the Supported New Alert characteristic value of the service.
...
/**@brief Read the Supported Unread Alert characteristic value of the service.
 *        The value describes the alerts supported in the master.
 *
 * @param[in]  p_ans       Alert Notification structure. This structure will have to be supplied by
 *                         the application. It identifies the particular client instance to use.
...
/**@brief Request the peer to notify the New Alert characteristics immediately.
 *
 * @param[in]  p_ans       Alert Notification structure. This structure will have to be supplied by
 *                         the application. It identifies the particular client instance to use.
...
/**@brief Request the peer to notify the Unread Alert characteristics immediately.
 *
 * @param[in]  p_ans       Alert Notification structure. This structure will have to be supplied by
 *                         the application. It identifies the particular client instance to use.
 * @param[in]  category    The category ID for which the peer should notify the client.
...
/**@brief   Load previous discovered service and characteristic handles for bonded masters from
 *          flash into RAM.
 *
...
/**@brief Stores discovered service and characteristic handles for bonded masters into flash memory.
 *
...
/**@brief   Deletes the Alert Notification Client database from flash.
 *
