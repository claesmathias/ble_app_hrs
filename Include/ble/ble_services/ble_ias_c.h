...
/**@brief Initialize the Immediate Alert Service client.
 *
...
/**@brief Send alert level to the peer.
 *
...
/**@brief BLE stack event handler for Immediate Alert Service client.
 *
...
/**@brief Function to check whether the peer's Immediate Alert Service instance and the alert level
