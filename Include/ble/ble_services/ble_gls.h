...
/**@brief Initialize the Glucose Service.
 *
...
/**@brief Glucose Service BLE stack event handler.
 *
...
/**@brief Reports a new glucose measurement to the glucose service module.
 *
