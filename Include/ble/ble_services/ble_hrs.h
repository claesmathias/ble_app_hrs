...
/**@brief Heart Rate Service BLE stack event handler.
 *
...
/**@brief Sends heart rate measurement if notification has been enabled.
 *
...
/**@brief Adds a RR Interval measurement to the RR Interval buffer.
 *
...
/**@brief Checks if RR Interval buffer is full.
 *
 * @param[in]   p_hrs        Heart Rate Service structure.
 *
...
/**@brief Sets the state of the Sensor Contact Supported bit.
 *
 * @param[in]   p_hrs                        Heart Rate Service structure.
...
/**@brief Sets the state of the Sensor Contact Detected bit.
 *
 * @param[in]   p_hrs                        Heart Rate Service structure.
