...
/**@brief Initialize the GPIOTE module.
 *
...
/**@brief Informs the GPIOTE module that the specified user wants to use the GPIOTE module.
 *
...
/**@brief Informs the GPIOTE module that the specified user is done using the GPIOTE module.
 *
 * @param[in]   user_id                   Id of user to enable.
 *
...
/**@brief Get the the state for the pins which are registered for the specified user.
 *
